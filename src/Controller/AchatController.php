...
{
    #[Route('/achat', name: 'app_achat_index', methods: ['GET'])]
    #[IsGranted("ROLE_USER")]
    ...
    #[Route('/achat/new', name: 'app_achat_new', methods: ['GET', 'POST'])]
    #[IsGranted("ROLE_USER")]
    ...
    #[Route('/achat/{id}/edit', name: 'app_achat_edit', methods: ['GET', 'POST'])]
    #[IsGranted("ROLE_USER")]
    ...
    #[Route('/achat/{id}/delete', name: 'app_achat_delete', methods: ['POST'])]
    #[IsGranted("ROLE_USER")]
