 ...
 */
final class Version20230803132813 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE achat_produit (achat_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_C26FA378F347EFB (produit_id), INDEX IDX_C26FA378FE95D117 (achat_id), PRIMARY KEY(achat_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
